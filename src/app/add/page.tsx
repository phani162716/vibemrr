...
export default function AddProductPage() {
  ...
  if (isSupabaseConfigured() && !session) {
    return (
      <div className="mx-auto max-w-md px-4 py-16">
        ...
        <p className="mt-2 text-sm text-zinc-400">A seller can list a product in a few minutes.</p>
        <div className="mt-6">
          <AuthPanel next="/add" />
        </div>
      </div>
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10">
      ...
      <p className="mt-2 text-sm text-zinc-400">Keep it short. You can list in a few minutes.</p>
      <form onSubmit={submit} className="mt-8 space-y-4">
        ...
        <button
          disabled={saving}
          className="rounded-xl bg-saffron px-4 py-2 text-sm font-semibold text-zinc-950 disabled:opacity-60"
        >
