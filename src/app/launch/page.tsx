...
export default function LaunchPage() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      <p className="text-xs font-semibold uppercase tracking-wider text-indigo-2">Publish</p>
      ...
      <ol className="mt-8 space-y-5 text-sm leading-7 text-muted">
        <li>
          <p className="font-semibold text-foreground">1. Push the repo to GitHub</p>
...
git push -u origin main`}</pre>
          <p className="mt-2 text-muted">Do not commit .env.local. It is already gitignored.</p>
        </li>
        <li>
          <p className="font-semibold text-foreground">2. Import the repo on Vercel</p>
          <p className="text-muted">
            Open{" "}
            <a className="text-indigo-2" href="https://vercel.com/new" target="_blank" rel="noreferrer">
              vercel.com/new
            </a>
            , import <code className="text-foreground">vibemrr</code>, framework Next.js.
          </p>
        </li>
        <li>
          <p className="font-semibold text-foreground">3. Add environment variables on Vercel</p>
...
NEXT_PUBLIC_SITE_URL=https://vibers.co`}</pre>
        ...
        <li>
          <p className="font-semibold text-foreground">4. Allow the live URL in Supabase</p>
          <p className="text-muted">
...
https://YOUR-APP.vercel.app/auth/callback`}</pre>
        ...
        <li>
          <p className="font-semibold text-foreground">5. Deploy → open the .vercel.app link</p>
          <p className="text-muted">
            Sign in, confirm your listing is there, then share{" "}
            <Link href="/invite" className="text-indigo-2">
              /invite
            </Link>{" "}
            with five founders.
          </p>
