  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="mt-8 space-y-6 text-sm leading-7 text-muted">
        <div>
          <h2 className="font-medium text-foreground">What is Vibers?</h2>
          <p className="mt-1">
        ...
        <div>
          <h2 className="font-medium text-foreground">How do payments work?</h2>
          <p className="mt-1">
        ...
        <div>
          <h2 className="font-medium text-foreground">Is listing free?</h2>
